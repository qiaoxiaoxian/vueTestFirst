  ...
  <div>
    <div class="peopleCarBox">
      ...
      <div class="peopleCar-start">
        <input type="text" placeholder="你在哪出发" v-on:click="postData(1)" v-bind:value="setStartPosition"
               readonly="readonly">
      </div>
      <div class="peopleCar-end">
        <input type="text" placeholder="你要去哪儿" v-on:click="postData(2)" v-bind:value="setEndPosition"
               readonly="readonly">
      </div>
      ...
      <div class="peopleCar-btn">
        <button type="button" v-on:click="showPriceBox">人找车</button>
      </div>
    </div>
        ...
        <transition name="price">
          <div class="peopleCar-priceBox" v-show="priceBox">
            ...
            <div class="peopleCar-priceInp">
              ...
              <div class="peopleCar-people">
                <span>打赏金额：</span>
                <input type="number" placeholder="打赏的人都进福布斯排行榜" v-model="reward" v-on:input="limitTip($event)">
              </div>
            </div>
  ...
  export default {
    ...
    computed: {
      ...
      setStartPosition: function () {
        let startAPosition = this.$store.state.a.position1
        this.startPosition = startAPosition
        this.startCoords = this.$store.state.a.coords1
        return startAPosition
      },
      setEndPosition: function () {
        let endAPosition = this.$store.state.a.position2
        this.endPosition = endAPosition
        this.endCoords = this.$store.state.a.coords2
        return endAPosition
      }
    },
    watch: {
